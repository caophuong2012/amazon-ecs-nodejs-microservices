...
var CollectionWhere = struct {
	...
	Title:        whereHelperstring{field: "\"collections\".\"title\""},
	Description:  whereHelperstring{field: "\"collections\".\"description\""},
	ImageURL:     whereHelpernull_String{field: "\"collections\".\"image_url\""},
	Network:      whereHelperstring{field: "\"collections\".\"network\""},
	Type:         whereHelpernull_String{field: "\"collections\".\"type\""},
	DisplayOrder: whereHelpernull_Int{field: "\"collections\".\"display_order\""},
	Slug:         whereHelperstring{field: "\"collections\".\"slug\""},
	Status:       whereHelperstring{field: "\"collections\".\"status\""},
	CreatorID:    whereHelperstring{field: "\"collections\".\"creator_id\""},
	CreatedAt:    whereHelpertime_Time{field: "\"collections\".\"created_at\""},
	UpdatedAt:    whereHelpertime_Time{field: "\"collections\".\"updated_at\""},
	DeleteAt:     whereHelpernull_Time{field: "\"collections\".\"delete_at\""},
}
...
var (
	collectionAllColumns            = []string{"id", "title", "description", "image_url", "network", "type", "display_order", "slug", "status", "creator_id", "created_at", "updated_at", "delete_at"}
	collectionColumnsWithoutDefault = []string{"id", "title", "description", "network", "slug", "status", "creator_id"}
	collectionColumnsWithDefault    = []string{"image_url", "type", "display_order", "created_at", "updated_at", "delete_at"}
...
func (q collectionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Collection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for collections")
	}
...
func (q collectionQuery) All(ctx context.Context, exec boil.ContextExecutor) (CollectionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "orm: failed to assign all query results to Collection slice")
	}
...
func (q collectionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count collections rows")
	}
...
func (q collectionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if collections exists")
	}
...
func FindCollection(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Collection, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from collections")
	}
...
func (o *Collection) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no collections provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into collections")
	}
...
func (o *Collection) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update collections, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update collections row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for collections")
	}
...
func (q collectionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for collections")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for collections")
	}
...
func (o CollectionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all in collection slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected all in update all collection")
	}
	return rowsAff, nil
}
...
func (o *Collection) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no collections provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert collections, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert collections")
	}
...
func (o *Collection) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("orm: no Collection provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from collections")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for collections")
	}
...
func (q collectionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("orm: no collectionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from collections")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for collections")
	}
...
func (o CollectionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from collection slice")
	}
...
func (o *CollectionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to reload all in CollectionSlice")
	}
...
func CollectionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if collections exists")
	}
